...
# 실제 발송 라벨은 laborwatch.py 내 categorize()에서 결정됩니다.
...
FEEDS = {
    ...
    "금감원-DART": [
        "https://dart.fss.or.kr/dsac001/main.do",            # 최신공시(HTML 파싱)
    ],

    # Google News RSS(키워드 기반)
    "노동-뉴스": [
    ...
    "금융-뉴스": [
        "https://news.google.com/rss/search?q=%EA%B8%88%EC%9C%B5%EC%9C%84%EC%9B%90%ED%9A%8C+OR+%EA%B8%88%EC%9C%84+OR+%EA%B8%88%EA%B0%90%EC%9B%90+OR+DART",
    ],
    "ESG-뉴스": [
